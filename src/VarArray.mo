...
module {
  ...
  /// assert VarArray.equal(array1, array2, equal);
  /// ```
  ///
  ...
  /// assert newArray == [var 0, 10, 20, 30];
  /// ```
  ///
  /// Runtime: O(size)
  ///
