...
module {
  ...
  ///     Nat.compare);
  ///
  ///   assert Map.all<Text>(map, func (k, v) = (v == debug_show(k)));
  ///   assert not Map.all<Text>(map, func (k, v) == (k < 2));
  /// }
  /// ```
  ///
  /// Runtime: `O(n)`.
  ...
  ///     Nat.compare);
  ///
  ///   assert Map.any<Text>(map, func (k, v) = (k >= 0));
  ///   assert not Map.any<Text>(map, func (k, v) = (k >= 3));
  /// }
  /// ```
  ///
  /// Runtime: `O(n)`.
